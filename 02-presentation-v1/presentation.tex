...
\begin{frame}{Tensorflow}
    ...
    Neural network is a graph of variables and a mathematical operations. And Tensorflow is a package that allows us to create such a graph and make computations. Therefore, in this work, we 
    \begin{enumerate}
...
Parameter $\gamma$ for noisy data: $u_{obs} = u + N(0, \sigma^2),$ $\sigma = 0.05\sqrt{u}.$ 
...
Comparison between the exact and the predicted solutions for the noisy data. $u_{obs} = u + N(0, \sigma^2),$ $\sigma = 0.05\sqrt{u}.$ \\
