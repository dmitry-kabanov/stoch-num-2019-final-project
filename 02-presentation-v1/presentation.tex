...
form the equation (1). As an activation function, we use $tanh(z)$. The depth of the model and the width of everyy layer depends on the amount of data we have. Below, we have considere the affection of the neural network configuration on the resulting values, such as solution function u(x, t) and $\lambda$s.
